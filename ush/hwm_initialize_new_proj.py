#!/usr/bin/env python
"""initialize.py: initialize new project json files for HWM LIVE and DAILY chart when a new project file is created"""
#+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
#directory to put new project initialized json files
jsond = os.environ["DATA"] + '/' + pdy + '/new_proj_files_'+rescount+'/'

epoch_now=(epoch_pdy*1000)

with open("new_wcossii_projects") as file:
