...
(function() {
        ...
        for (var c = "{", d = !1, e, f, g, h, i, j = []; (c = a.indexOf(c)) !== -1; ) {
            ...
            if (d) {
                ...
                if (f.length)
                    ...
                    e !== null && (e = y.numberFormat(e, i, h.decimalPoint, f.indexOf(",") > -1 ? h.thousandsSep : ""))) : e = Oa(f, e)
            }
            j.push(e);
            a = a.slice(c + 1);
            c = (d = !d) ? "}" : "{"
    ...
    function Cb() {
        var a = S.global
          ...
          , c = b ? "getUTC" : "get"
          , d = b ? "setUTC" : "set";
        za = a.Date || window.Date;
        mb = b && a.timezoneOffset;
        eb = b && a.getTimezoneOffset;
        gb = function(a, c, d, h, i, j) {
            var k;
            b ? (k = za.UTC.apply(0, arguments),
            k += Wa(k)) : k = (new za(a,c,p(d, 1),p(h, 0),p(i, 0),p(j, 0))).getTime();
            return k
        }
        ;
        qb = c + "Minutes";
    ...
    var u, C = document, K = window, V = Math, x = V.round, U = V.floor, sa = V.ceil, s = V.max, J = V.min, P = V.abs, W = V.cos, Z = V.sin, la = V.PI, ga = la * 2 / 360, ma = navigator.userAgent, Gb = K.opera, xa = /(msie|trident)/i.test(ma) && !Gb, hb = C.documentMode === 8, wb = /AppleWebKit/.test(ma), Ua = /Firefox/.test(ma), Hb = /(Mobile|Android|Windows Phone)/.test(ma), Aa = "http://www.w3.org/2000/svg", ba = !!C.createElementNS && !!C.createElementNS(Aa, "svg").createSVGRect, Lb = Ua && parseInt(ma.split("Firefox/")[1], 10) < 4, ea = !ba && !xa && !!C.createElement("canvas").getContext, $a, ab, Ib = {}, xb = 0, fb, S, Oa, ya, yb, F, na = function() {
        return u
    }, $ = [], bb = 0, Ka = "div", L = "none", Mb = /^[0-9]+$/, ib = ["plotTop", "marginRight", "marginBottom", "plotLeft"], Nb = "stroke-width", za, gb, mb, eb, qb, rb, sb, Xa, Ya, Za, Db, Eb, tb, ub, vb, N = {}, y;
    y = K.Highcharts = K.Highcharts ? ka(16, !0) : {};
    y.seriesTypes = N;
    var r = y.extend = function(a, b) {
        var c;
        a || (a = {});
        for (c in b)
            a[c] = b[c];
    ...
    Oa = function(a, b, c) {
        if (!q(b) || isNaN(b))
            return "Invalid date";
        var a = p(a, "%Y-%m-%d %H:%M:%S"), d = new za(b - Wa(b)), e, f = d[rb](), g = d[sb](), h = d[Xa](), i = d[Ya](), j = d[Za](), k = S.lang, m = k.weekdays, d = r({
            a: m[g].substr(0, 3),
            A: m[g],
            d: Ia(h),
            e: h,
                ...
                a.fn.highcharts = function() {
                    ...
                    if (this[0]) {
                        ...
                        if (c !== u)
                            ...
                            new y[a](c,b[1]),
                            g = this;
                        c === u && (g = $[H(this[0], "data-highcharts-chart")])
                    }
                    return g
                }
            },
    ...
    var Rb = /rgba\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]?(?:\.[0-9]+)?)\s*\)/
      ...
      , oa = function(a) {
        var b = [], c, d;
        (function(a) {
            a && a.stops ? d = Ma(a.stops, function(a) {
                return oa(a[1])
    ...
    M.prototype = {
        ...
        colorGradient: function(a, b, c) {
            var d = this.renderer, e, f, g, h, i, j, k, m, n, o, t = [];
            ...
            if (f) {
                ...
                f === "radialGradient" && n && !q(g.gradientUnits) && (g = z(g, {
                ...
                for (o in j)
                    t.push(j[o]);
                t = t.join(",");
                h[t] ? a = h[t].attr("id") : (g.id = a = "highcharts-" + xb++,
                h[t] = i = d.createElement(f).attr(g).add(d.defs),
                i.stops = [],
                l(j, function(a) {
                    a[1].indexOf("rgba") === 0 ? (e = oa(a[1]),
                    k = e.get("rgb"),
                    m = e.get("a")) : (k = a[1],
                    m = 1);
        ...
        applyTextShadow: function(a) {
            var b = this.element, c, d = a.indexOf("contrast") !== -1, e = ma.indexOf("Safari") > 0 && ma.indexOf("Chrome") === -1, e = b.style.textShadow !== u && !xa && !e;
            d && (a = a.replace(/contrast/g, this.renderer.getContrast(b.style.fill)));
            e ? d && I(b, {
                textShadow: a
            }) : (this.ySetter = this.xSetter,
            c = [].slice.call(b.getElementsByTagName("tspan")),
            l(a.split(/\s?,\s?/g), function(a) {
                var d = b.firstChild, e, i, a = a.split(" ");
                e = a[a.length - 1];
                (i = a[a.length - 2]) && l(c, function(a, c) {
                    var f;
        ...
        symbolAttr: function(a) {
            var b = this;
            l("x,y,r,start,end,width,height,innerR,anchorX,anchorY".split(","), function(c) {
                b[c] = p(a[c], b[c])
            });
            b.attr({
        ...
        clip: function(a) {
            return this.attr("clip-path", a ? "url(" + this.renderer.url + "#" + a.id + ")" : L)
        },
        crisp: function(a) {
        ...
        on: function(a, b) {
            ...
            ab && a === "click" ? (d.ontouchstart = function(a) {
                c.touchEventFired = za.now();
                a.preventDefault();
                b.call(d, a)
            }
            ,
            d.onclick = function(a) {
                (ma.indexOf("Android") === -1 || za.now() - (c.touchEventFired || 0) > 1100) && b.call(d, a)
            }
            ) : d["on" + a] = b;
            return this
        },
        ...
        getBBox: function(a) {
            ...
            d = this.element;
            var f = this.styles, g = e * ga, h = this.textStr, i;
            h !== u && (i = ["", e || 0, f && f.fontSize, d.style.width].join(","),
            i = h === "" || Mb.test(h) ? "num:" + h.toString().length + i : h + i);
            i && !a && (b = c.cache[i]);
            if (!b) {
                if (d.namespaceURI === Aa || c.forExport) {
                    try {
                        b = d.getBBox ? r({}, d.getBBox()) : {
                            width: d.offsetWidth,
                ...
                if (c.isSVG) {
                    a = b.width;
                    d = b.height;
                    if (xa && f && f.fontSize === "11px" && d.toPrecision(3) === "16.9")
                        b.height = d = 14;
                    if (e)
                        b.width = P(d * Z(g)) + P(a * W(g)),
                        b.height = P(d * W(g)) + P(a * Z(g))
                }
                c.cache[i] = b
            }
            return b
        ...
        titleSetter: function(a) {
            ...
            b || (b = C.createElementNS(Aa, "title"),
    ...
    M.prototype["stroke-widthSetter"] = M.prototype.strokeSetter = function(a, b, c) {
        ...
        if (this.stroke && this["stroke-width"])
            ...
            M.prototype.fillSetter.call(this, this.stroke, "stroke", c),
    ...
    ta.prototype = {
        ...
        init: function(a, b, c, d, e) {
            ...
            g = d.element;
            a.appendChild(g);
            a.innerHTML.indexOf("xmlns") === -1 && H(g, "xmlns", Aa);
            this.isSVG = !0;
            this.box = g;
            this.boxWrapper = d;
            this.alignedObjects = [];
            this.url = (Ua || wb) && C.getElementsByTagName("base").length ? f.href.replace(/#.*?$/, "").replace(/([\('\)])/g, "\\$1").replace(/ /g, "%20") : "";
            this.createElement("desc").add().element.appendChild(C.createTextNode("Created with Highcharts 4.1.1"));
        ...
        destroy: function() {
            ...
            if (a)
                this.defs = a.destroy();
            this.subPixelFix && X(K, "resize", this.subPixelFix);
        ...
        buildText: function(a) {
            for (var b = a.element, c = this, d = c.forExport, e = p(a.textStr, "").toString(), f = e.indexOf("<") !== -1, g = b.childNodes, h, i, j = H(b, "x"), k = a.styles, m = a.textWidth, n = k && k.lineHeight, o = k && k.textShadow, t = k && k.textOverflow === "ellipsis", w = g.length, T = m && !a.added && this.box, D = function(a) {
                return n ? B(n) : c.fontMetrics(/(px|em)$/.test(a && a.style.fontSize) ? a.style.fontSize : k && k.fontSize || c.style.fontSize || 12, a).h
            }, v = function(a) {
                return a.replace(/&lt;/g, "<").replace(/&gt;/g, ">")
            }; w--; )
                b.removeChild(g[w]);
            !f && !o && !t && e.indexOf(" ") === -1 ? b.appendChild(C.createTextNode(v(e))) : (h = /<.*style="([^"]+)".*>/,
            i = /<.*href="(http[^"]+)".*>/,
            T && T.appendChild(b),
            ...
            l(e, function(e, f) {
                ...
                l(g, function(e) {
                    if (e !== "" || g.length === 1) {
                        var o = {}, w = C.createElementNS(Aa, "tspan"), p;
                        h.test(e) && (p = e.match(h)[1].replace(/(;| |^)color([ :])/, "$1fill$2"),
                        H(w, "style", p));
                        i.test(e) && !d && (H(w, "onclick", 'location.href="' + e.match(i)[1] + '"'),
                        I(w, {
                            cursor: "pointer"
                        }));
                        e = v(e.replace(/<(.|\n)*?>/g, "") || " ");
                        if (e !== " ") {
                            ...
                            H(w, "dy", D(w)));
                            if (m) {
                                for (var o = e.replace(/([^\^])-/g, "$1- ").split(" "), l = g.length > 1 || f || o.length > 1 && k.whiteSpace !== "nowrap", T, q, u, Ba = [], s = D(w), x = 1, r = a.rotation, z = e, y = z.length; (l || t) && (o.length || Ba.length); )
                                    a.rotation = 0,
                                    T = a.getBBox(!0),
                                    u = T.width,
                                    ...
                                    t && q ? (y /= 2,
                                    z === "" || !T && y < 0.5 ? o = [] : (T && (q = !0),
                                    z = e.substring(0, z.length + (T ? -1 : 1) * sa(y)),
                                    o = [z + "…"],
                                    w.removeChild(w.firstChild))) : !T || o.length === 1 ? (o = Ba,
                                    Ba = [],
                                    o.length && (x++,
                                    ...
                                    p && H(w, "style", p),
                                    b.appendChild(w)),
                                    u > m && (m = u)) : (w.removeChild(w.firstChild),
                                    Ba.unshift(o.pop())),
                                    o.length && w.appendChild(C.createTextNode(o.join(" ").replace(/- /g, "-")));
                                q && a.attr("title", a.textStr);
                                a.rotation = r
                            }
                            n++
                        }
        ...
        button: function(a, b, c, d, e, f, g, h, i) {
            var j = this.label(a, b, c, i, null, null, null, null, "button"), k = 0, m, n, o, t, w, p, a = {
                x1: 0,
                y1: 0,
                x2: 0,
                y2: 1
            ...
            p = h.style;
            delete h.style;
            O(j.element, xa ? "mouseover" : "mouseenter", function() {
                k !== 3 && j.attr(f).css(t)
            });
            O(j.element, xa ? "mouseout" : "mouseleave", function() {
                k !== 3 && (m = [e, f, g][k],
                n = [o, t, w][k],
                j.attr(m).css(n))
            });
            j.setState = function(a) {
                (j.state = k = a) ? a === 2 ? j.attr(g).css(w) : a === 3 && j.attr(h).css(p) : j.attr(e).css(o)
            }
            ;
        ...
        label: function(a, b, c, d, e, f, g, h, i) {
            function j() {
                ...
                o.height = (s || p.height || 0) + 2 * v;
                J = v + n.fontMetrics(a && a.fontSize, t).b;
                if (A) {
                    if (!w)
                        a = x(-D * v),
                        b = h ? -J : 0,
                        o.box = w = d ? n.symbol(d, a, b, o.width, o.height, E) : n.rect(a, b, o.width, o.height, 0, E[Nb]),
                        w.attr("fill", L).add(o);
                    w.isImg || w.attr(r({
                        width: x(o.width),
                        height: x(o.height)
            ...
            function k() {
                var a = o.styles, a = a && a.textAlign, b = Ba + v * (1 - D), c;
                c = h ? 0 : J;
                if (q(fa) && p && (a === "center" || a === "right"))
                    b += {
                        center: 0.5,
                        right: 1
                    }[a] * (fa - p.width);
            ...
            var n = this, o = n.g(i), t = n.text("", 0, 0, g).attr({
                zIndex: 1
            }), w, p, D = 0, v = 3, Ba = 0, fa, s, y, C, B = 0, E = {}, J, A;
            o.onAdd = function() {
                t.add(o);
                o.attr({
                    text: a || a === 0 ? a : "",
    ...
    r(M.prototype, {
        ...
        htmlUpdateTransform: function() {
            if (this.added) {
                ...
                if (b.tagName === "SPAN") {
                    var k = this.rotation, m, n = B(this.textWidth), o = [k, g, b.innerHTML, this.textWidth].join(",");
                    if (o !== this.cTT) {
        ...
        setSpanRotation: function(a, b, c) {
            var d = {}
              , e = xa ? "-ms-transform" : wb ? "-webkit-transform" : Ua ? "MozTransform" : Gb ? "-o-transform" : "";
    ...
    if (!ba && !ea) {
        A = {
            ...
            setSpanRotation: function() {
                var a = this.rotation
                  ...
                  , c = Z(a * ga);
                I(this.element, {
                    filter: a ? ["progid:DXImageTransform.Microsoft.Matrix(M11=", b, ", M12=", -c, ", M21=", c, ", M22=", b, ", sizingMethod='auto expand')"].join("") : L
                })
            },
            getSpanCorrection: function(a, b, c, d, e) {
                var f = d ? W(d * ga) : 1, g = d ? Z(d * ga) : 0, h = p(this.elemHeight, this.element.offsetHeight), i;
                this.xCorr = f < 0 && -a;
                this.yCorr = g < 0 && -h;
                i = f * g < 0;
            ...
            shadow: function(a, b, c) {
                var d = [], e, f = this.element, g = this.renderer, h, i = f.style, j, k = f.path, m, n, o, t;
                ...
                if (a) {
                    ...
                    for (e = 1; e <= 3; e++) {
                        ...
                        if (c)
                            h.cutOff = m + 1;
                        j = ['<stroke color="', a.color || "black", '" opacity="', t * e, '"/>'];
        ...
        var Na = {
            ...
            color: function(a, b, c, d) {
                var e = this, f, g = /^rgba/, h, i, j = L;
                a && a.linearGradient ? i = "gradient" : a && a.radialGradient && (i = "pattern");
                if (i) {
                    var k, m, n = a.linearGradient || a.radialGradient, o, t, w, p, D, v = "", a = a.stops, q, fa = [], u = function() {
                        h = ['<fill colors="' + fa.join(",") + '" opacity="', w, '" o:opacity2="', t, '" type="', i, '" ', v, 'focus="100%" method="any" />'];
                    ...
                    if (c === "fill")
                        if (i === "gradient")
                            ...
                            var j = n.r, s = j * 2, x = j * 2, r = n.cx, E = n.cy, z = b.radialReference, y, j = function() {
                                z && (y = d.getBBox(),
                                r += (z[0] - y.x) / y.width - 0.5,
                                E += (z[1] - y.y) / y.height - 0.5,
                                s *= z[2] / y.width,
                                x *= z[2] / y.height);
                                v = 'src="' + S.global.VMLRadialGradientURL + '" size="' + s + "," + x + '" origin="0.5,0.5" position="' + r + "," + E + '" color2="' + D + '" ';
                                u()
                            };
                            d.added ? j() : d.onAdd = j;
                            j = p
            ...
            symbols: {
                ...
                rect: function(a, b, c, d, e) {
                    return ta.prototype.symbols[!q(e) || !e.r ? "square" : "callout"].call(0, a, b, c, d, e)
                }
            }
        };
    ...
    Ta.prototype = {
        ...
        handleOverflow: function(a) {
            ...
            if (h)
                h < 0 && c - i * j < f ? k = x(c / W(h * ga) - f) : h > 0 && c + i * j > e && (k = x((d - c) / W(h * ga)));
            else {
                d = c - i * j;
                c += i * j;
                if (d < f)
        ...
        render: function(a, b, c) {
            var d = this.axis
              ...
              , y = r.x
              , r = r.y
              , z = g && y === d.pos + d.len || !g && r === d.pos ? -1 : 1
              , c = p(c, 1);
            this.isActive = !0;
            if (t) {
                j = d.getPlotLinePath(j + x, t * z, b, !0);
                if (m === u) {
                    m = {
                        stroke: w,
                        "stroke-width": t
                    ...
                    if (b)
                        m.opacity = 0;
                    this.gridLine = m = t ? f.path(j).attr(m).add(d.gridGroup) : null
                }
                if (!b && m && j)
            ...
            if (n && D)
                q === "inside" && (D = -D),
                d.opposite && (D = -D),
                h = this.getMarkPath(y, r, D, n * z, g, f),
                o ? o.animate({
                    d: h,
                    opacity: c
            ...
            if (i && !isNaN(y))
                i.xy = r = this.getLabelPosition(y, r, i, g, k, x, a, fa),
    ...
    y.PlotLineOrBand.prototype = {
        render: function() {
            var a = this, b = a.axis, c = b.horiz, d = a.options, e = d.label, f = a.label, g = d.width, h = d.to, i = d.from, j = q(i) && q(h), k = d.value, m = d.dashStyle, n = a.svgElem, o = [], t, w = d.color, p = d.zIndex, l = d.events, v = {}, s = b.chart.renderer;
            b.isLog && (i = Ea(i),
            h = Ea(h),
            k = Ea(k));
            if (g) {
                if (o = b.getPlotLinePath(k, g),
                v = {
                    stroke: w,
                    "stroke-width": g
                },
            ...
            else if (o && o.length && (a.svgElem = n = s.path(o).attr(v).add(),
            l))
                ...
                l)
                    d(t);
            if (e && q(e.text) && o && o.length && b.width > 0 && b.height > 0) {
                e = z({
                    align: c && j && "center",
                    x: c ? !j && 4 : 10,
                ...
                if (!f) {
                    ...
                    if (q(p))
                        v.zIndex = p;
                    a.label = f = s.text(e.text, 0, 0, e.useHTML).attr(v).css(e.style).add()
                }
                b = [o[1], o[4], j ? o[6] : o[1]];
                j = [o[2], o[5], j ? o[7] : o[2]];
                o = Pa(b);
    ...
    ua.prototype = {
        ...
        defaultYAxisOptions: {
            ...
            stackLabels: {
                ...
                style: aa.line.dataLabels.style
            }
        },
        ...
        defaultLabelFormatter: function() {
            ...
            if (h)
                ...
                for (; f-- && g === u; )
                    c = Math.pow(1E3, f + 1),
                    a >= c && e[f] !== null && (g = y.numberFormat(b / c, -1) + e[f]);
            g === u && (g = P(b) >= 1E4 ? y.numberFormat(b, 0) : y.numberFormat(b, -1, u, ""));
            return g
        },
            ...
            l(a.series, function(c) {
                if (c.visible || !b.options.chart.ignoreHiddenSeries) {
                    ...
                    if (a.isXAxis) {
                        if (d = c.xData,
                        d.length)
                            a.dataMin = J(p(a.dataMin, d[0]), Pa(d)),
                            a.dataMax = s(p(a.dataMax, d[0]), Fa(d))
                    } else {
                        c.getExtremes();
                        e = c.dataMax;
                        c = c.dataMin;
                        if (q(c) && q(e))
                            a.dataMin = J(p(a.dataMin, c), c),
                            a.dataMax = s(p(a.dataMax, e), e);
                        if (q(d))
                            if (a.dataMin >= d)
                                a.dataMin = d,
        ...
        translate: function(a, b, c, d, e, f) {
            var g = 1
              ...
              , e = (this.postTranslate || this.isLog && e) && this.lin2val;
            if (!i)
                i = this.transA;
            if (c)
                g *= -1,
            ...
            f === "between" && (f = 0.5),
            a = g * (a - d) * i + h + g * j + (qa(f) ? i * f * this.pointRange : 0));
            return a
        },
        ...
        adjustForMinRange: function() {
            ...
            if (this.isXAxis && this.minRange === u && !this.isLog)
                q(a.min) || q(a.max) ? this.minRange = null : (l(this.series, function(a) {
                    i = a.xData;
        ...
        setAxisTranslation: function(a) {
            ...
            if (b.isXAxis || i || d)
                ...
                g = h.pointRangePadding) : l(b.series, function(a) {
                    var h = i ? 1 : b.isXAxis ? a.pointRange : b.axisPointRange || 0
                      , j = a.options.pointPlacement
                      , o = a.closestPointRange;
                    h > c && (h = 0);
                    d = s(d, h);
                    b.single || (f = s(f, Da(j) ? 0 : h / 2),
                    g = s(g, j === "on" ? 0 : h));
                    !a.noSharedTooltip && q(o) && (e = q(e) ? J(e, o) : o)
                }),
        ...
        setTickInterval: function(a) {
            ...
            d.type !== b.linkedParent.options.type && ka(11, 1)) : (b.min = p(b.userMin, d.min, b.dataMin),
            b.max = p(b.userMax, d.max, b.dataMax));
            if (e)
                !a && J(b.min, p(b.dataMin, b.min)) <= 0 && ka(10, 1),
                b.min = da(Ea(b.min)),
                b.max = da(Ea(b.max));
            if (b.range && q(b.max))
            ...
            if (!n && !b.axisPointRange && !b.usePercentage && !h && q(b.min) && q(b.max) && (c = b.max - b.min)) {
                if (!q(d.min) && !q(b.userMin) && j && (b.dataMin < 0 || !b.ignoreMinPadding))
                    b.min -= c * j;
                if (!q(d.max) && !q(b.userMax) && i && (b.dataMax > 0 || !b.ignoreMaxPadding))
                    b.max += c * i
            }
            if (qa(d.floor))
                b.min = s(b.min, d.floor);
            if (qa(d.ceiling))
                b.max = J(b.max, d.ceiling);
            b.tickInterval = b.min === b.max || b.min === void 0 || b.max === void 0 ? 1 : h && !k && m === b.linkedParent.options.tickPixelInterval ? b.linkedParent.tickInterval : p(k, this.tickAmount ? (b.max - b.min) / s(this.tickAmount - 1, 1) : void 0, n ? 1 : (b.max - b.min) * m / s(b.len, m));
            ...
            if (!k && b.tickInterval < a)
                b.tickInterval = a;
            if (!f && !e && !k)
                b.tickInterval = ob(b.tickInterval, null, nb(b.tickInterval), p(d.allowDecimals, !(b.tickInterval > 0.5 && b.tickInterval < 5 && b.max > 1E3 && b.max < 9999)), !!this.tickAmount);
        ...
        zoom: function(a, b) {
            var c = this.dataMin
              , d = this.dataMax
              , e = this.options;
            this.allowZoomOutside || (q(c) && a <= J(c, p(e.min, c)) && (a = u),
            q(d) && b >= s(d, p(e.max, d)) && (b = u));
        ...
        unsquish: function() {
            ...
            c ? (m = q(h) ? [h] : f < 80 && !b.staggerLines && !b.step && b.autoRotation) && l(m, function(a) {
                var b;
                a && a >= -90 && a <= 90 && (j = n(P(i.h / Z(ga * a))),
                b = j + P(a / 360),
                b < k && (k = b,
                g = a,
                e = j))
        ...
        renderUnsquish: function() {
            ...
            if (this.autoRotation)
                ...
                for (h = c.length; !f && h--; )
                    if (i = c[h],
                    (i = d[i].label) && this.len / c.length - 4 < i.getBBox().height)
                        i.specCss = {
                            textOverflow: "ellipsis"
                        }
            }
        ...
        getOffset: function() {
            var a = this, b = a.chart, c = b.renderer, d = a.options, e = a.tickPositions, f = a.ticks, g = a.horiz, h = a.side, i = b.inverted ? [1, 0, 3, 2][h] : h, j, k, m = 0, n, o = 0, t = d.title, w = d.labels, T = 0, D = b.axisOffset, b = b.clipOffset, v = [-1, 1, 1, -1][h], r;
            ...
            D[h] = s(D[h], a.axisTitleMargin + m + v * a.offset, g);
            b[i] = s(b[i], U(d.lineWidth / 2) * 2)
        },
        ...
        render: function() {
            var a = this, b = a.chart, c = b.renderer, d = a.options, e = a.isLog, f = a.isLinked, g = a.tickPositions, h = a.axisTitle, i = a.ticks, j = a.minorTicks, k = a.alternateBands, m = d.stackLabels, n = d.alternateGridColor, o = a.tickmarkOffset, t = d.lineWidth, w, p = b.hasRendered && q(a.oldMin) && !isNaN(a.oldMin);
            w = a.hasData;
            var D = a.showAxis, v, r;
            ...
            if (w || f) {
                ...
                n && l(g, function(b, c) {
                    if (c % 2 === 0 && b < a.max)
                        k[b] || (k[b] = new y.PlotLineOrBand(a)),
                        v = b + o,
                ...
                if (!a._addedPlotLB)
                    l((d.plotLines || []).concat(d.plotBands || []), function(b) {
        ...
        destroy: function(a) {
            ...
            for (a = e.length; a--; )
                e[a].destroy();
            l("stackTotalGroup,axisLine,axisTitle,axisGroup,cross,gridGroup,labelGroup".split(","), function(a) {
                b[a] && (b[a] = b[a].destroy())
            });
        ...
        drawCrosshair: function(a, b) {
            ...
            if (!this.crosshair || (q(b) || !p(this.crosshair.snap, !0)) === !1 || q(b) && p(this.crosshair.snap, !0) && (!b.series || b.series[this.isXAxis ? "xAxis" : "yAxis"] !== this))
                this.hideCrosshair();
            else if (p(d.snap, !0) ? q(b) && (c = this.chart.inverted != this.horiz ? b.plotX : this.len - b.plotY) : c = this.horiz ? a.chartX - this.pos : this.len - a.chartY + this.pos,
    ...
    r(ua.prototype, {
        ...
        removePlotBandOrLine: function(a) {
            ...
            l([c.plotLines || [], d.plotLines || [], c.plotBands || [], d.plotBands || []], function(b) {
                for (e = b.length; e--; )
                    b[e].id === a && ia(b, b[e])
            })
        }
    ...
    ua.prototype.getTimeTicks = function(a, b, c, d) {
        var e = [], f = {}, g = S.global.useUTC, h, i = new za(b - Wa(b)), j = a.unitRange, k = a.count;
        if (q(b)) {
            i.setMilliseconds(j >= F.second ? 0 : k * U(i.getMilliseconds() / k));
            j >= F.second && i.setSeconds(j >= F.minute ? 0 : k * U(i.getSeconds() / k));
            if (j >= F.minute)
                i[Db](j >= F.hour ? 0 : k * U(i[qb]() / k));
            if (j >= F.hour)
                i[Eb](j >= F.day ? 0 : k * U(i[rb]() / k));
            if (j >= F.day)
                i[tb](j >= F.month ? 1 : k * U(i[Xa]() / k));
            j >= F.month && (i[ub](j >= F.year ? 0 : k * U(i[Ya]() / k)),
            h = i[Za]());
            j >= F.year && (h -= h % k,
            i[vb](h));
            if (j === F.week)
                i[tb](i[Xa]() - i[sb]() + p(d, 1));
            b = 1;
            if (mb || eb)
                i = i.getTime(),
                i = new za(i + Wa(i));
            h = i[Za]();
            for (var d = i.getTime(), m = i[Ya](), n = i[Xa](), o = (F.day + (g ? Wa(i) : i.getTimezoneOffset() * 6E4)) % F.day; d < c; )
                e.push(d),
                j === F.year ? d = gb(h + b * k, 0) : j === F.month ? d = gb(h, m + b * k) : !g && (j === F.day || j === F.week) ? d = gb(h, m, n + b * k * (j === F.day ? 1 : 7)) : d += j * k,
                b++;
            e.push(d);
            l(zb(e, function(a) {
    ...
    ua.prototype.normalizeTimeTickInterval = function(a, b) {
        ...
        c = ob(a / e, f, d[0] === "year" ? s(nb(a / e), 1) : 1);
        return {
            unitRange: e,
            count: c,
            unitName: d[0]
    ...
    ua.prototype.getLogTickPositions = function(a, b, c, d) {
        ...
        if (a >= 0.5)
            ...
            for (var f = U(b), h, i, j, k, m, e = a > 0.3 ? [1, 2, 4] : a > 0.15 ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; f < c + 1 && !m; f++) {
                i = e.length;
                for (h = 0; h < i && !m; h++)
                    j = Ea(ha(f) * e[h]),
        ...
        a = ob(a, null, nb(a)),
        g = Ma(this.getLinearTickPositions(a, b, c), Ea),
        !d)
    ...
    Kb.prototype = {
        ...
        getPosition: function(a, b, c) {
            var d = this.chart, e = this.distance, f = {}, g, h = ["y", d.chartHeight, b, c.plotY + d.plotTop], i = ["x", d.chartWidth, a, c.plotX + d.plotLeft], j = p(c.ttBelow, d.inverted && !c.negative || !d.inverted && c.negative), k = function(a, b, c, d) {
                ...
                k.apply(0, h) !== !1 ? m.apply(0, i) === !1 && !g && (n(!0),
                o()) : g ? f.x = f.y = 0 : (n(!0),
                o())
            };
        ...
        refresh: function(a, b) {
            ...
            var h = c.hoverPoints, k, m = this.shared;
            clearTimeout(this.hideTimer);
            ...
            i === !1 ? this.hide() : (this.isHidden && (db(d),
    ...
    Va.prototype = {
        init: function(a, b) {
            ...
            this.pinchDown = [];
            this.lastValidTouch = {};
            if (y.Tooltip && b.tooltip.enabled)
                a.tooltip = new Kb(a,b.tooltip),
        ...
        normalize: function(a, b) {
            ...
            if (!b)
                this.chartPosition = b = Pb(this.chart.container);
            d.pageX === u ? (c = s(a.x, a.clientX - b.left),
        ...
        runPointActions: function(a) {
            var b = this.chart, c = b.series, d = b.tooltip, e = d ? d.shared : !1, f, g = b.hoverPoint, h = b.hoverSeries, i = b.chartWidth, j = b.chartWidth, k, m = [], n;
            if (!e && !h)
                for (f = 0; f < c.length; f++)
                    if (c[f].directTouch || !c[f].options.stickyTracking)
                        c = [];
            (!h || !h.noSharedTooltip) && (e || !h) ? (l(c, function(b) {
                k = b.noSharedTooltip && e;
                b.visible && !k && p(b.options.enableMouseTracking, !0) && m.push(b.searchPoint(a))
            }),
            l(m, function(a) {
                if (a && q(a.plotX) && q(a.plotY) && (a.dist.distX < i || (a.dist.distX === i || a.series.kdDimensions > 1) && a.dist.distR < j))
                    i = a.dist.distX,
                    j = a.dist.distR,
                    n = a
            })) : n = h ? h.searchPoint(a) : u;
            if (n && d && n !== g)
                if (e && !n.series.noSharedTooltip) {
                    f = m.length;
                    for (c = n.plotX + n.series.xAxis.left; f--; )
                        h = m[f].plotX + m[f].series.xAxis.left,
                        (m[f].x !== n.x || h !== c || !q(m[f].y) || m[f].series.noSharedTooltip) && m.splice(f, 1);
                    d.refresh(m, a);
                    l(m, function(b) {
                        b.onMouseOver(a)
                    })
                ...
                f = h && h.tooltipOptions.followPointer,
                d && f && !d.isHidden && (f = d.getAnchor([{}], a),
                d.updatePosition({
                    plotX: f[0],
                    plotY: f[1]
                }));
        ...
        drag: function(a) {
            var b = this.chart, c = b.options.chart, d = a.chartX, e = a.chartY, f = this.zoomHor, g = this.zoomVert, h = b.plotLeft, i = b.plotTop, j = b.plotWidth, k = b.plotHeight, m, n = this.mouseDownX, o = this.mouseDownY, t = c.panKey && a[c.panKey + "Key"];
            d < h ? d = h : d > h + j && (d = h + j);
            e < i ? e = i : e > i + k && (e = i + k);
            this.hasDragged = Math.sqrt(Math.pow(n - d, 2) + Math.pow(o - e, 2));
            if (this.hasDragged > 10) {
                m = b.isInsidePlot(n - h, o - i);
                if (b.hasCartesianSeries && (this.zoomX || this.zoomY) && m && !t && !this.selectionMarker)
                    this.selectionMarker = b.renderer.rect(h, i, f ? 1 : j, g ? 1 : k, 0).attr({
                        fill: c.selectionMarkerFill || "rgba(69,114,167,0.25)",
                        zIndex: 7
                    }).add();
                this.selectionMarker && f && (d -= n,
                this.selectionMarker.attr({
                    width: P(d),
                    x: (d > 0 ? 0 : d) + n
                }));
                this.selectionMarker && g && (d = e - o,
                this.selectionMarker.attr({
                    height: P(d),
                    y: (d > 0 ? 0 : d) + o
                }));
        ...
        onContainerClick: function(a) {
            var b = this.chart
              ...
              , a = this.normalize(a);
            a.cancelBubble = !0;
            b.cancelClick || (c && this.inClass(a.target, "highcharts-tracker") ? (G(c.series, "click", r(a, {
                point: c
            })),
        ...
        setDOMEvents: function() {
            ...
            bb === 1 && O(C, "mouseup", a.onDocumentMouseUp);
            if (ab)
        ...
        destroy: function() {
            ...
            bb || (X(C, "mouseup", this.onDocumentMouseUp),
            X(C, "touchend", this.onDocumentTouchEnd));
    ...
    r(y.Pointer.prototype, {
        ...
        pinchTranslateDirection: function(a, b, c, d, e, f, g, h) {
            var i = this.chart, j = a ? "x" : "y", k = a ? "X" : "Y", m = "chart" + k, n = a ? "width" : "height", o = i["plot" + (a ? "Left" : "Top")], t, p, l = h || 1, D = i.inverted, v = i.bounds[a ? "h" : "v"], q = b.length === 1, r = b[0][m], s = c[0][m], u = !q && b[1][m], x = !q && c[1][m], y, c = function() {
                !q && P(r - u) > 20 && (l = h || P(s - x) / P(r - u));
                p = (o - s) / l + r;
                t = i["plot" + (a ? "Width" : "Height")] / l
            };
            c();
            b = p;
            b < v.min ? (b = v.min,
            y = !0) : b + t > v.max && (b = v.max - t,
            y = !0);
            y ? (s -= 0.8 * (s - g[j][0]),
            q || (x -= 0.8 * (x - g[j][1])),
            c()) : g[j] = [s, x];
    ...
    if (K.PointerEvent || K.MSPointerEvent) {
        var va = {}
          ...
          , Bb = function(a, b, c, d) {
            a = a.originalEvent || a;
            if ((a.pointerType === "touch" || a.pointerType === a.MSPOINTER_TYPE_TOUCH) && $[Ca])
                d(a),
                d = $[Ca].pointer,
                d[b]({
                    type: c,
        ...
        cb(Va.prototype, "setDOMEvents", function(a) {
            a.apply(this);
            (this.hasZoom || this.followTouchMove) && this.batchMSEvents(O)
        });
    ...
    lb.prototype = {
        ...
        renderItem: function(a) {
            ...
            if (!l) {
                ...
                a.legendItem = l = c.text(d.labelFormat ? Ja(d.labelFormat, a) : d.labelFormatter.call(a), m ? f + g : -g, this.baseline || 0, r).css(z(a.visible ? h : i)).attr({
                    align: m ? "left" : "right",
                    zIndex: 2
                }).add(a.legendGroup);
                if (!this.baseline)
                    this.baseline = c.fontMetrics(h.fontSize, l).f + 3 + t,
                    l.attr("y", this.baseline);
                q.drawLegendSymbol(this, a);
                this.setItemEvents && this.setItemEvents(a, l, r, h, i);
            ...
            if (e && this.itemX - w + f > (n || b.chartWidth - 2 * j - w - d.x))
                this.itemX = w,
                this.itemY += t + this.lastLineHeight + o;
            this.maxItemWidth = s(this.maxItemWidth, f);
            this.lastItemY = t + this.itemY + o;
            this.lastLineHeight = s(g, this.lastLineHeight);
            a._legendItemPos = [this.itemX, this.itemY];
            e ? this.itemX += f : (this.itemY += t + g + o,
            this.lastLineHeight = g);
            this.offsetWidth = n || s((e ? this.itemX - w - k : f) + j, this.offsetWidth)
        },
        getAllItems: function() {
            var a = [];
            l(this.chart.series, function(b) {
                var c = b.options;
                if (p(c.showInLegend, !q(c.linkedTo) ? u : !1, !0))
        ...
        handleOverflow: function(a) {
            var b = this, c = this.chart, d = c.renderer, e = this.options, f = e.y, f = c.spacingBox.height + (e.verticalAlign === "top" ? -f : f) - this.padding, g = e.maxHeight, h, i = this.clipRect, j = e.navigation, k = p(j.animation, !0), m = j.arrowSize || 12, n = this.nav, o = this.pages, t, w = this.allItems;
    ...
    Na = y.LegendSymbolMixin = {
        ...
        drawLineMarker: function(a) {
            ...
            d = a.symbolWidth;
            var e = this.chart.renderer, f = this.legendGroup, a = a.baseline - x(e.fontMetrics(a.options.itemStyle.fontSize, this.legendItem).b * 0.3), g;
            if (b.lineWidth) {
                g = {
    ...
    (/Trident\/7\.0/.test(ma) || Ua) && cb(lb.prototype, "positionItem", function(a, b) {
        var c = this
          , d = function() {
    ...
    A.prototype = {
        ...
        redraw: function(a) {
            var b = this.axes, c = this.series, d = this.pointer, e = this.legend, f = this.isDirtyLegend, g, h, i = this.hasCartesianSeries, j = this.isDirtyBox, k = c.length, m = k, n = this.renderer, o = n.isHidden(), t = [];
            Sa(a, this);
        ...
        getSelectedPoints: function() {
            ...
            l(this.series, function(b) {
                a = a.concat(zb(b.points || [], function(a) {
                    return a.selected
                }))
            });
            return a
        ...
        getSelectedSeries: function() {
            return zb(this.series, function(a) {
                return a.selected
            })
        },
        getStacks: function() {
        ...
        setSize: function(a, b, c) {
            ...
            if (q(a))
                d.chartWidth = e = s(0, x(a)),
                d.hasUserSize = !!e;
            if (q(b))
                d.chartHeight = f = s(0, x(b));
            (ya ? kb : I)(d.container, {
                width: e + "px",
                height: f + "px"
            }, ya);
        ...
        setChartSize: function(a) {
            ...
            this.plotWidth = k = s(0, x(d - i - this.marginRight));
            this.plotHeight = m = s(0, x(e - j - this.marginBottom));
        ...
        drawChartBox: function() {
            ...
            if (k)
                f ? f.animate(v) : this.plotBackground = b.rect(t, p, l, q, 0).attr({
                    fill: k
                }).add().shadow(a.plotShadow);
            if (m)
                h ? h.animate(v) : this.plotBGImage = b.image(m, t, p, l, q).add();
            r ? r.animate({
                width: s.width,
                height: s.height
            ...
            if (n)
                g ? g.animate(g.crisp({
                    ...
                    height: q,
                    strokeWidth: -n
                })) : this.plotBorder = b.rect(t, p, l, q, 0, -n).attr({
        ...
        isReadyToRender: function() {
            var a = this;
            return !ba && K == K.top && C.readyState !== "complete" || ea && !K.canvg ? (ea ? Jb.push(function() {
                a.firstRender()
    ...
    var Vb = y.CenteredSeriesMixin = {
        getCenter: function() {
            var a = this.options, b = this.chart, c = 2 * (a.slicedOffset || 0), d, e = b.plotWidth - 2 * c, f = b.plotHeight - 2 * c, b = a.center, a = [p(b[0], "50%"), p(b[1], "50%"), a.size || "100%", a.innerSize || 0], g = J(e, f), h;
    ...
    R.prototype = {
        ...
        setData: function(a, b, c, d) {
            var e = this, f = e.points, g = f && f.length || 0, h, i = e.options, j = e.chart, k = null, m = e.xAxis, n = m && !!m.categories, o = i.turboThreshold, t = this.xData, w = this.yData, q = (h = e.pointArrayMap) && h.length, a = a || [];
            h = a.length;
            b = p(b, !0);
        ...
        generatePoints: function() {
            ...
            for (n = 0; n < g; n++)
                i = h + n,
                j ? m[n] = (new f).init(this, [d[n]].concat(ra(e[n]))) : (b[i] ? k = b[i] : a[i] !== u && (b[i] = k = (new f).init(this, a[i], d[n])),
                m[n] = k),
                m[n].index = i;
            if (b && (g !== (c = b.length) || j))
                for (n = 0; n < c; n++)
        ...
        getExtremes: function(a) {
            ...
            for (m = 0; m < d; m++)
                ...
                j = this.getExtremesFromAll || this.cropped || (c[m + 1] || j) >= g && (c[m - 1] || j) <= h,
                i && j)
                    if (i = k.length)
                        for (; i--; )
                            k[i] !== null && (e[f++] = k[i]);
        ...
        translate: function() {
            ...
            this.generatePoints();
            for (var a = this.options, b = a.stacking, c = this.xAxis, d = c.categories, e = this.yAxis, f = this.points, g = f.length, h = !!this.modifyValue, i = a.pointPlacement, j = i === "between" || qa(i), k = a.threshold, m, n, o, t = Number.MAX_VALUE, a = 0; a < g; a++) {
                var l = f[a]
                  , r = l.x
                  , D = l.y;
                n = l.low;
                var v = b && e.stacks[(this.negStacks && D < k ? "-" : "") + this.stackKey];
                if (e.isLog && D !== null && D <= 0)
                    l.y = D = null,
                    ka(10);
                l.plotX = m = c.translate(r, 0, 0, 0, 1, i, this.type === "flags");
                if (b && this.visible && v && v[r])
                    ...
                    n === 0 && (n = p(k, e.min)),
                    e.isLog && n <= 0 && (n = null),
                    l.total = l.stackTotal = v.total,
                    l.percentage = v.total && l.y / v.total * 100,
                    l.stackY = D,
                    v.setOffset(this.pointXOffset || 0, this.barW || 0);
                l.yBottom = q(n) ? e.translate(n, 0, 1, 0, 1) : null;
                h && (D = this.modifyValue(D, l));
                l.plotY = n = typeof D === "number" && D !== Infinity ? J(s(-1E5, e.translate(D, 0, 1, 0, 1)), 1E5) : u;
                l.isInside = n !== u && n >= 0 && n <= e.len && m >= 0 && m <= c.len;
                l.clientX = j ? c.translate(r, 0, 0, 0, 1) : m;
                l.negative = l.y < (k || 0);
        ...
        setClip: function(a) {
            ...
            a || (h.count -= 1,
            h.count <= 0 && g && b[g] && (e || (b[g] = b[g].destroy()),
        ...
        drawPoints: function() {
            var a, b = this.points, c = this.chart, d, e, f, g, h, i, j, k, m = this.options.marker, n = this.pointAttr[""], o, l, w, q = this.markerGroup, s = p(m.enabled, this.xAxis.isRadial, this.closestPointRangePx > 2 * m.radius);
                ...
                for (f = b.length; f--; )
                    ...
                    a && e !== u && !isNaN(e) && g.y !== null)
                        ...
                        k)
                            ...
                            if (w && (h > 0 || j))
                                g.graphic = c.renderer.symbol(i, d - h, e - h, 2 * h, 2 * h, l ? o : m).attr(a).add(q)
                        }
                    else if (k)
                        g.graphic = k.destroy()
        },
        ...
        getAttribs: function() {
            ...
            var o = c.lineColor
              , p = c.fillColor;
            j = b.turboThreshold;
            var w = a.zones, s = a.zoneAxis || "y", u;
            b.marker ? (e.radius = e.radius || c.radius + e.radiusPlus,
            e.lineWidth = e.lineWidth || c.lineWidth + e.lineWidthPlus) : (e.color = e.color || oa(e.color || g).brighten(e.brightness).get(),
            ...
            if (!j || g < j || m)
                for (; g--; ) {
                    ...
                    if (m) {
                        ...
                        f = d.hover = d.hover || {};
                        if (!b.marker)
                            f.color = f.color || !j.options.color && e[j.negative && h ? "negativeColor" : "color"] || oa(j.color).brighten(f.brightness || e.brightness).get();
                        f = {
                            color: j.color
                        };
                        if (!p)
        ...
        destroy: function() {
            var a = this, b = a.chart, c = /AppleWebKit\/533/.test(ma), d, e, f = a.data || [], g, h, i;
            G(a, "destroy");
            X(a);
            ...
            l("area,graph,dataLabelsGroup,group,markerGroup,tracker,graphNeg,areaNeg,posClip,negClip".split(","), function(b) {
        ...
        applyZones: function() {
            var a = this, b = this.chart, c = b.renderer, d = this.zones, e, f, g = this.clips || [], h, i = this.graph, j = this.area, k = s(b.chartWidth, b.chartHeight), m = this[(this.zoneAxis || "y") + "Axis"], n = m.reversed, o = m.horiz;
            if (d.length && (i || j))
                i.hide(),
                j && j.hide(),
                l(d, function(d, i) {
                    e = p(f, n ? o ? b.plotWidth : 0 : o ? 0 : m.toPixels(m.min));
                    f = x(m.toPixels(p(d.value, m.max), !0));
                    if (m.isXAxis) {
                        if (h = {
                            x: n ? f : e,
                            y: 0,
                    ...
                    g[i] ? g[i].animate(h) : (g[i] = c.clipRect(h),
                    a["colorGraph" + i].clip(g[i]),
        ...
        render: function() {
            ...
            c = a.options;
            var d = c.animation
              , d = d && !!a.animate && b.renderer.isSVG && p(d.duration, 500) || 0
              , e = a.visible ? "visible" : "hidden"
              , f = c.zIndex
              , g = a.hasRendered
              , h = b.seriesGroup;
            c = a.plotGroup("group", "series", e, f, h);
            ...
            d && a.animate();
            if (!g)
                d ? a.animationTimeout = setTimeout(function() {
                    a.afterAnimate()
                }, d) : a.afterAnimate();
        ...
        searchKDTree: function(a) {
            function b(a, h, i, j) {
                var k = h.point, m = c.kdAxisArray[i % j], n, o = k;
                n = q(a[e]) && q(k[e]) ? Math.pow(a[e] - k[e], 2) : null;
                var l = q(a[f]) && q(k[f]) ? Math.pow(a[f] - k[f], 2) : null
                  , p = (n || 0) + (l || 0);
                n = {
                    distX: q(n) ? Math.sqrt(n) : Number.MAX_VALUE,
                    distY: q(l) ? Math.sqrt(l) : Number.MAX_VALUE,
                    distR: q(p) ? Math.sqrt(p) : Number.MAX_VALUE
                };
                k.dist = n;
                m = a[m] - k[m];
                n = m < 0 ? "left" : "right";
                ...
                k = m < 0 ? "right" : "left",
                h[k] && Math.sqrt(m * m) < o.dist[d] && (a = b(a, h[k], i + 1, j),
            ...
            return this.kdTree ? b(a, this.kdTree, this.kdDimensions, this.kdDimensions) : u
        }
    };
    Fb.prototype = {
        destroy: function() {
    ...
    ;
    ua.prototype.renderStackTotals = function() {
    ...
    R.prototype.setStackedPoints = function() {
        if (this.options.stacking && !(this.visible !== !0 && this.chart.options.chart.ignoreHiddenSeries !== !1)) {
            var a = this.processedXData, b = this.processedYData, c = [], d = b.length, e = this.options, f = e.threshold, g = e.stack, e = e.stacking, h = this.stackKey, i = "-" + h, j = this.negStacks, k = this.yAxis, m = k.stacks, n = k.oldStacks, o, l, p, q, r, v;
            for (q = 0; q < d; q++) {
                r = a[q];
                v = b[q];
                p = this.index + "," + q;
                ...
                m[l] || (m[l] = {});
                if (!m[l][r])
                    n[l] && n[l][r] ? (m[l][r] = n[l][r],
                    m[l][r].total = null) : m[l][r] = new Fb(k,k.options.stackLabels,o,r,g);
                l = m[l][r];
                l.points[p] = [l.cum || 0];
                e === "percent" ? (o = o ? h : i,
                j && m[o] && m[o][r] ? (o = m[o][r],
                l.total = o.total = s(o.total, l.total) + P(v) || 0) : l.total = da(l.total + (P(v) || 0))) : l.total = da(l.total + (v || 0));
                l.cum = (l.cum || 0) + (v || 0);
                l.points[p].push(l.cum);
                c[q] = l.cum
            }
            if (e === "percent")
                k.usePercentage = !0;
    ...
    r(R.prototype, {
        addPoint: function(a, b, c, d) {
            var e = this.options, f = this.data, g = this.graph, h = this.area, i = this.chart, j = this.xAxis && this.xAxis.names, k = g && g.shift || 0, m = e.data, n, o = this.xData;
            Sa(d, i);
            c && l([g, h, this.graphNeg, this.areaNeg], function(a) {
                if (a)
                    a.shift = k + 1
            });
            if (h)
    ...
    var pa = ja(R, {
        type: "area",
        getSegments: function() {
            var a = this, b = [], c = [], d = [], e = this.xAxis, f = this.yAxis, g = f.stacks[this.stackKey], h = {}, i, j, k = this.points, m = this.options.connectNulls, n, o;
    ...
    wa = ja(R, {
        ...
        getPointSpline: function(a, b, c) {
            ...
            if (f && g) {
                ...
                k += m;
                i > a && i > e ? (i = s(a, e),
                k = 2 * e - i) : i < a && i < e && (i = J(a, e),
                k = 2 * e - i);
                k > g && k > e ? (k = s(g, e),
                i = 2 * e - k) : k < g && k < e && (k = J(g, e),
                i = 2 * e - k);
                b.rightContX = j;
                b.rightContY = k
            }
    ...
    wa = ja(R, {
        ...
        getColumnMetrics: function() {
            ...
            var c = J(P(c.transA) * (c.ordinalSlope || b.pointRange || c.closestPointRange || c.tickInterval || 1), c.len)
              , j = c * b.groupPadding
              , k = (c - 2 * j) / i
              , m = b.pointWidth
        ...
        translate: function() {
            ...
            l(a.points, function(c) {
                var d = p(c.yBottom, f), h = J(s(-999 - d, c.plotY), e.len + 999 + d), l = c.plotX + k, q = j, r = J(h, d), u;
                u = s(h, d) - r;
                P(u) < g && g && (u = g,
                r = x(P(r - f) > g ? d - g : f - (e.translate(c.y, 0, 1, 0, 1) <= f ? g : 0)));
                c.barX = l;
                c.pointWidth = i;
                c.tooltipPos = b.inverted ? [e.len + e.pos - b.plotLeft - h, a.xAxis.len - l - q / 2] : [l + q / 2, h + e.pos - b.plotTop];
                q = x(l + q) + m;
                l = x(l) + m;
                q -= l;
                d = P(r) < 0.5;
        ...
        animate: function(a) {
            ...
            if (ba)
                a ? (e.scaleY = 0.001,
                a = J(b.pos + b.len, s(b.pos, b.toPixels(c.threshold))),
    ...
    Q = {
        ...
        pointClass: ja(Ga, {
            ...
            setVisible: function(a) {
                ...
                l(["graphic", "dataLabel", "connector", "shadowGroup"], function(c) {
                    if (b[c])
                        b[c][a ? "show" : "hide"](!0)
                });
        ...
        translate: function(a) {
            this.generatePoints();
            var b = 0, c = this.options, d = c.slicedOffset, e = d + c.borderWidth, f, g, h, i = c.startAngle || 0, j = this.startAngleRad = la / 180 * (i - 90), i = (this.endAngleRad = la / 180 * (p(c.endAngle, i + 360) - 90)) - j, k = this.points, m = c.dataLabels.distance, c = c.ignoreHiddenPoint, n, o = k.length, l;
            if (!a)
                this.center = a = this.getCenter();
            this.getX = function(b, c) {
                h = V.asin(J((b - a[1]) / (a[2] / 2 + m), 1));
            ...
            for (n = 0; n < o; n++) {
                ...
                f = W(h) * a[2] / 2;
                g = Z(h) * a[2] / 2;
                l.tooltipPos = [a[0] + f * 0.7, a[1] + g * 0.7];
                l.half = h < -la / 2 || h > la / 2 ? 1 : 0;
                l.angle = h;
                e = J(e, m / 2);
                l.labelPos = [a[0] + f + W(h) * m, a[1] + g + Z(h) * m, a[0] + f + W(h) * e, a[1] + g + Z(h) * e, a[0] + f, a[1] + g, m < 0 ? "center" : l.half ? "right" : "left", h]
            }
        },
        drawGraph: null,
        drawPoints: function() {
    ...
    R.prototype.drawDataLabels = function() {
        ...
        if (d.enabled || a._hasPointLabels)
            ...
            g = d,
            l(e, function(e) {
                var h, l = e.dataLabel, t, s, x = e.connector, y = !0, v, C = {};
                ...
                if (l && !h)
                    ...
                    h = d.rotation;
                    t = e.getLabelConfig();
                    i = d.format ? Ja(d.format, t) : d.formatter.call(t, d);
                    ...
                    if (l)
                        ...
                        if (v.color === "contrast")
                            C.color = d.inside || d.distance < 0 || b.stacking ? k.getContrast(e.color || a.color) : "#000000";
                        if (c)
                            C.cursor = c;
                        for (s in l)
                            l[s] === u && delete l[s];
                        l = e.dataLabel = k[h ? "text" : "label"](i, 0, -999, null, null, null, d.useHTML).attr(l).css(r(v, C)).add(j).shadow(d.shadow)
                    }
    ...
    R.prototype.alignDataLabel = function(a, b, c, d, e) {
        ...
        if (a = this.visible && (a.series.forceDL || f.isInsidePlot(h, x(i), g) || d && f.isInsidePlot(h, g ? d.x + 1 : d.y + d.height - 1, g)))
            d = r({
                x: g ? f.plotWidth - i : h,
            ...
            c.rotation ? (f = f.renderer.rotCorr(k, c.rotation),
            b[e ? "attr" : "animate"]({
    ...
    if (N.pie)
        N.pie.prototype.drawDataLabels = function() {
            var a = this, b = a.data, c, d = a.chart, e = a.options.dataLabels, f = p(e.connectorPadding, 10), g = p(e.connectorWidth, 1), h = d.plotWidth, i = d.plotHeight, j, k, m = p(e.softConnector, !0), n = e.distance, o = a.center, q = o[2] / 2, r = o[1], u = n > 0, y, v, z, C = [[], []], B, A, F, I, E, G = [0, 0, 0, 0], N = function(a, b) {
                return b.y - a.y
            };
            if (a.visible && (e.enabled || a._hasPointLabels)) {
                ...
                for (I = 2; I--; ) {
                    var K = [], O = [], H = C[I], M = H.length, L;
                    if (M) {
                        a.sortByAngle(H, I - 0.5);
                        for (E = b = 0; !b && H[E]; )
                            b = H[E] && H[E].dataLabel && (H[E].dataLabel.getBBox().height || 21),
                            E++;
                        if (n > 0) {
                            v = J(r + q + n, d.plotHeight);
                            for (E = s(0, r - q - n); E <= v; E += b)
                                K.push(E);
                            v = K.length;
                            if (M > v) {
                                c = [].concat(H);
                            ...
                            for (E = 0; E < M; E++) {
                                ...
                                if (L < E && K[E] !== null)
                                    ...
                                    for (v < M - E + L && K[E] !== null && (L = v - M + E); K[L] === null; )
                                        L++;
                                O.push({
                                    i: L,
                                    y: K[L]
                        ...
                        for (E = 0; E < M; E++) {
                            ...
                            if (n > 0) {
                                ...
                                L = v.i,
                                A = v.y,
                                c > A && K[L + 1] !== null || c < A && K[L - 1] !== null)
                                    A = J(s(0, c), d.plotHeight)
                            } else
                                A = c;
                            B = e.justify ? o[0] + (I ? -1 : 1) * (q + n) : a.getX(A === r - q - n || A === r + q + n ? c : A, I);
                            y._attr = {
                                visibility: F,
                                align: z[6]
                            };
                            ...
                            if (this.options.size === null)
                                v = y.width,
                                B - v < f ? G[3] = s(x(v - B + f), G[3]) : B + v > h - f && (G[1] = s(x(B + v - h + f), G[1])),
                                A - b / 2 < 0 ? G[0] = s(x(-A + b / 2), G[0]) : A + b / 2 > i && (G[2] = s(x(A + b / 2 - i), G[2]))
                        }
                    }
                }
                if (Fa(G) === 0 || this.verifyDataLabelOverflow(G))
                    this.placeDataLabels(),
                    u && g && l(this.points, function(b) {
                        j = b.connector;
                        z = b.labelPos;
                        if ((y = b.dataLabel) && y._pos)
                            F = y._attr.visibility,
                            B = y.connX,
                            A = y.connY,
                            k = m ? ["M", B + (z[6] === "left" ? 5 : -5), A, "C", B, A, 2 * z[2] - z[4], 2 * z[3] - z[5], z[2], z[3], "L", z[4], z[5]] : ["M", B + (z[6] === "left" ? 5 : -5), A, "L", z[2], z[3], "L", z[4], z[5]],
                            j ? (j.animate({
                                d: k
                            }),
        ...
        ,
        N.pie.prototype.alignDataLabel = na,
        N.pie.prototype.verifyDataLabelOverflow = function(a) {
            var b = this.center, c = this.options, d = c.center, e = c = c.minSize || 80, f;
            d[0] !== null ? e = s(b[2] - s(a[1], a[3]), c) : (e = s(b[2] - a[1] - a[3], c),
            b[0] += (a[3] - a[1]) / 2);
            d[1] !== null ? e = s(J(e, b[2] - s(a[0], a[2])), c) : (e = s(J(e, b[2] - a[0] - a[2]), c),
            b[1] += (a[0] - a[2]) / 2);
            e < b[2] ? (b[2] = e,
            this.translate(b),
            l(this.points, function(a) {
    ...
    (function(a) {
        ...
        b.prototype.callbacks.push(function(a) {
            function b() {
                ...
                c(a.series, function(a) {
                    ...
                    (b.enabled || a._hasPointLabels) && !b.allowOverlap && c(a.points, function(a) {
                        if (a.dataLabel)
        ...
        b.prototype.hideOverlappingLabels = function(a) {
            ...
            for (d = 0; d < b; d++) {
                ...
                for (c = d + 1; c < b; ++c)
                    if (j = a[c],
                    i && j && i.placed && j.placed && i.newOpacity !== 0 && j.newOpacity !== 0 && !(j.alignAttr.x > i.alignAttr.x + i.width || j.alignAttr.x + j.width < i.alignAttr.x || j.alignAttr.y > i.alignAttr.y + i.height || j.alignAttr.y + j.height < i.alignAttr.y))
    ...
    if (N.column)
        wa.prototype.drawTracker = Q.drawTrackerPoint;
    if (N.pie)
        N.pie.prototype.drawTracker = Q.drawTrackerPoint;
    if (N.scatter)
        pa.prototype.drawTracker = Q.drawTrackerPoint;
    r(lb.prototype, {
        ...
        pan: function(a, b) {
            ...
            l(b === "xy" ? [1, 0] : [1], function(b) {
                var d = a[b ? "chartX" : "chartY"]
                  ...
                  , i = i > d;
                if (h.series.length && (i || m > J(k.dataMin, k.min)) && (!i || j < s(k.dataMax, k.max)))
    ...
    r(Ga.prototype, {
        ...
        setState: function(a, b) {
            var c = this.plotX, d = this.plotY, e = this.series, f = e.options.states, g = aa[e.type].marker && e.options.marker, h = g && !g.enabled, i = g && g.states[a], j = i && i.enabled === !1, k = e.stateMarkerGraphic, m = this.marker || {}, l = e.chart, o = e.halo, p, a = a || "";
                ...
                if (this.graphic)
                    ...
                    if (a && i)
                        ...
                        k)
                            ...
                            e.stateMarkerGraphic = k = l.renderer.symbol(m, c - g, d - g, 2 * g, 2 * g).attr(p).add(e.markerGroup),
                            k.currentSymbol = m;
                    if (k)
                        k[a && l.isInsidePlot(c, d, l.inverted) ? "show" : "hide"]()
                }
