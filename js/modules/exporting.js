...
*/
(function(f) {
    var A = f.Chart, t = f.addEvent, B = f.removeEvent, C = HighchartsAdapter.fireEvent, l = f.createElement, o = f.discardElement, v = f.css, k = f.merge, r = f.each, p = f.extend, E = Math.max, j = document, D = window, F = f.isTouchDevice, G = f.Renderer.prototype.symbols, s = f.getOptions(), y;
    p(s.lang, {
    ...
    p(A.prototype, {
        getSVG: function(a) {
            var b = this, d, c, z, h, g = k(b.options, a);
            if (!j.createElementNS)
                j.createElementNS = function(b, a) {
        ...
        exportChart: function(a, b) {
            var a = a || {}
              ...
              , d = this.getSVG(k({
                ...
                exporting: {
                    sourceWidth: a.sourceWidth || d.sourceWidth,
                    sourceHeight: a.sourceHeight || d.sourceHeight
                }
            }))
        ...
        contextMenu: function(a, b, d, c, f, h, g) {
            var e = this, k = e.options.navigation, q = k.menuItemStyle, m = e.chartWidth, n = e.chartHeight, j = "cache-" + a, i = e[j], u = E(f, h), w, x, o, s = function(b) {
                e.pointer.inClass(b.target, a) || x()
            };
            if (!i)
                e[j] = i = l("div", {
                    className: a
            ...
            d + e.exportMenuWidth > m ? b.right = m - d - f - u + "px" : b.left = d - u + "px";
            c + h + e.exportMenuHeight > n && g.alignOptions.verticalAlign !== "top" ? b.bottom = n - c - u + "px" : b.top = c + h - u + "px";
            v(i, b);
            e.openMenu = !0
        },
        addButton: function(a) {
            var b = this, d = b.renderer, c = k(b.options.navigation.buttonOptions, a), j = c.onclick, h = c.menuItems, g, e, l = {
            ...
            if (c.enabled !== !1) {
                ...
                : h && (i = function() {
                    b.contextMenu(e.menuClassName, h, e.translateX, e.translateY, e.width, e.height, e);
                    e.setState(2)
                }
                );
        ...
        destroyExport: function(a) {
            ...
            for (b = 0; b < a.exportSVGElements.length; b++)
                if (d = a.exportSVGElements[b])
                    d.onclick = d.ontouchstart = null,
                    a.exportSVGElements[b] = d.destroy();
            for (b = 0; b < a.exportDivElements.length; b++)
                d = a.exportDivElements[b],
                B(d, "mouseleave"),
                a.exportDivElements[b] = d.onmouseout = d.onmouseover = d.ontouchstart = d.onclick = null,
                o(d)
        }
    });
    G.menu = function(a, b, d, c) {
        return ["M", a, b + 2.5, "L", a + d, b + 2.5, "M", a, b + c / 2 + 0.5, "L", a + d, b + c / 2 + 0.5, "M", a, b + c - 1.5, "L", a + d, b + c - 1.5]
    }
    ;
    A.prototype.callbacks.push(function(a) {
        var b, d = a.options.exporting, c = d.buttons;
        y = 0;
        if (d.enabled !== !1) {
            for (b in c)
                a.addButton(c[b]);
